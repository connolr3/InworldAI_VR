...
/// </summary>
public class ProximityTeleportationStudyExperiment : Experiment {
    ...
    public ProximityTeleportationStudyExperiment(ExperimentRunner runner, RunnableDesign runnableDesign) : base(runner, runnableDesign) {
