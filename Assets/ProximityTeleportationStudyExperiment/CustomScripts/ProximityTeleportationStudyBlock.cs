...
/// </summary>
public class ProximityTeleportationStudyBlock : Block {
    ...
    public ProximityTeleportationStudyBlock(ExperimentRunner runner, DataTable trialTable, DataRow data, int index) : base(runner, trialTable, data, index) {
